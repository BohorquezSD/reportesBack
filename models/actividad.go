...
type Actividad struct {
	Id                       int          `orm:"column(idactividad);pk"`
	Descripcion              string       `orm:"column(descripcion);null"`
	Fecharegistro            time.Time    `orm:"column(fecharegistro);type(date);null"`
	Fechalimite              time.Time    `orm:"column(fechalimite);type(date);null"`
	Responsableid            int          `orm:"column(responsableid);null"`
	Soporte                  string       `orm:"column(soporte);null"`
	Estado                   string       `orm:"column(estado);null"`
	ResponsableIdresponsable *Responsable `orm:"column(responsable_idresponsable);rel(fk)"`
}
